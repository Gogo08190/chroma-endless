onEvent('recipes', (event) => {
    ...
    const recipes = [
        ...
        // Nanorite Solar Cell
        {
            ...
            inputs: [
                { type: 'masterfulmachinery:items', data: { item: 'kubejs:nanorite_photovoltaic_panel', count: 1 } },
                { type: 'masterfulmachinery:items', data: { item: 'kubejs:advanced_extreme_circuit_board', count: 1 } },
                { type: 'masterfulmachinery:items', data: { item: 'enviroenergy:aethium_solar_cell', count: 1 } },
                { type: 'masterfulmachinery:energy', data: { amount: 3000 } }
            ],
            ticks: 140,
