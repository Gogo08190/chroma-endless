  ...
  onEvent('ponder.registry', (event) => {
    event
      ...
      .scene(
        ...
        'chroma:tetra/forge_hammer/forge_hammer',
        (scene, util) => {
          scene.showBasePlate();
          ...
          .showText(60)
          .colored(PonderPalette.WHITE)
          .text(`Using the Forge Hammer will drain charge from the Magmatic Cells, which will need to be replaced when depleted.`)
          .independent(0);
          scene.idle(35);
          scene
          .overlay()
