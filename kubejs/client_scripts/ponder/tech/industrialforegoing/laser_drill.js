...
onEvent('ponder.registry', (event) => {
    ...
    event
        ...
        //.tag('chroma:industrial_foregoing')
        .scene(
            'introduction',
            'How to use the Laser Drill',
            'chroma:industrial_foregoing/laser_drill/example_setup',
            (scene, util) => {
                scene.showBasePlate();
        ...
        .scene(
            'ether_gas',
            'Getting Ether Gas',
            'chroma:industrial_foregoing/laser_drill/wither_milker',
            (scene, util) => {
                scene.showBasePlate();
                ...
                scene
                    ...
                    .showText(60)
                    .colored(PonderPalette.WHITE)
                    .text(`Say Hi to the camera, Kiki!`)
                    .placeNearTarget()
                    .pointAt([3.5, 4, 3.5]);
                ...
                scene
                    ...
                    .colored(PonderPalette.WHITE)
                    .text(
                        `Now that dear Kiki over here is trapped by the Stasis Chamber and cannot wreck our stuff,` +
                            ` we can use the Fluid Laser to... milk him.`
                    )
                    .placeNearTarget()
                    .pointAt([3.5, 4, 3.5]);
